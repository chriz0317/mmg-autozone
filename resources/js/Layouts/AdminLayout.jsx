            ...
            >
                ...
                <nav className="flex-1 p-4 space-y-2 overflow-y-auto overflow-x-hidden">
                    ...
                    <Link 
                        ...
                        title="Inventory"
                        className={`w-full flex items-center gap-3 p-3 rounded-xl transition font-semibold text-sm ${isActive('/admin/inventory') ? 'text-white' : 'text-gray-400 hover:text-white'}`}
                        style={isActive('/admin/inventory') ? { background: 'linear-gradient(135deg, #ea580c, #f97316)', boxShadow: '0 4px 12px rgba(249,115,22,0.2)' } : {}}
                    >
                        ...
                        <span className={`transition-opacity duration-200 whitespace-nowrap ${isSidebarOpen ? 'opacity-100' : 'opacity-0 w-0 overflow-hidden hidden'}`}>Inventory</span>
                    </Link>
                </nav>
