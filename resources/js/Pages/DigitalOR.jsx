        ...
        <div className="min-h-screen flex flex-col font-sans text-slate-800 bg-slate-50 print:bg-white print:min-h-0">
            ...
            <main className="flex-1 w-full max-w-4xl mx-auto p-4 md:p-8">
                ...
                <div className="mb-6 flex flex-wrap justify-end gap-3 print:hidden">
                    ...
                    <a 
                        href={`/or/${transaction.id}/pdf`}
                        className="bg-red-600 text-white px-6 py-2.5 rounded-lg font-bold text-sm hover:bg-red-500 transition-colors flex items-center gap-2 shadow-sm"
                    >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                        Download PDF O.R.
                    </a>
